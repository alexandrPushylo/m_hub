...
url = 'http://samsebeyurist.by/spravochnaya-informatsiya/tarify/tarify-na-zhku/tarify-na-jelektrojenergiju'
...
if response.status_code == 200:
    ...
    div = soup.find('div', {'id': 'tarif_S'})
    print(div.findChild())
    # for li in div.fetchNextSiblings(name='ul'):
    #     print(li)
